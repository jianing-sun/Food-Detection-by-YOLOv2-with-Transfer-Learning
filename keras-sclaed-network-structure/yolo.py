...
def create_yolov3_model(
    ...
    x = depthwise_separable_conv_block(x, dw_stride=(1, 1), pw_num_filter=64, id=1)
    # Conv dw / s2: filter shape (3 x 3 x 64 dw)    Conv pw / s1: filter shape (1 x 1 x 64 x 128)
    x = depthwise_separable_conv_block(x, dw_stride=(2, 2), pw_num_filter=128, id=2)
    # Conv dw / s1: filter shape (3 x 3 x 128 dw)   Conv pw / s1: filter shape (1 x 1 x 128 x 128)
    x = depthwise_separable_conv_block(x, dw_stride=(1, 1), pw_num_filter=128, id=3)
    # Conv dw / s2: filter shape (3 x 3 x 128 dw)   Conv pw / s1: filter shape (1 x 1 x 128 x 256)
    x = depthwise_separable_conv_block(x, dw_stride=(2, 2), pw_num_filter=256, id=4)
    # Conv dw / s1: filter shape (3 x 3 x 256 dw)   Conv pw / s1: filter shape (1 x 1 x 256 x 256)
    x = depthwise_separable_conv_block(x, dw_stride=(1, 1), pw_num_filter=256, id=5)

    # Conv dw / s2: filter shape (3 x 3 x 256 dw)   Conv pw / s1: filter shape (1 x 1 x 256 x 512)
    x = depthwise_separable_conv_block(x, dw_stride=(2, 2), pw_num_filter=512, id=10)
    x = depthwise_separable_conv_block(x, dw_stride=(2, 2), pw_num_filter=512, id=11)
    ...
    # repeat 5 times
    x = depthwise_separable_conv_block(x, dw_stride=(1, 1), pw_num_filter=512, id=12)
    x = depthwise_separable_conv_block(x, dw_stride=(1, 1), pw_num_filter=512, id=13)
    x = depthwise_separable_conv_block(x, dw_stride=(1, 1), pw_num_filter=512, id=14)
    ...
    x = depthwise_separable_conv_block(x, dw_stride=(1, 1), pw_num_filter=512, id=16)
    x = depthwise_separable_conv_block(x, dw_stride=(1, 1), pw_num_filter=512, id=17)

    # Conv dw / s2: filter shape (3 x 3 x 512 dw)   Conv pw / s1: filter shape (1 x 1 x 512 x 1024)
    x = depthwise_separable_conv_block(x, dw_stride=(1, 1), pw_num_filter=1024, id=18)  # stride 2 -> 1

    # Conv dw / s2: filter shape (3 x 3 x 1024 dw)  Conv pw / s1: filter shape (1 x 1 x 1024 x 1024)
    x = depthwise_separable_conv_block(x, dw_stride=(1, 1), pw_num_filter=1024, id=19)
